...
#
# Created: Thu Oct 18 22:51:12 2012
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.macLabel = QtGui.QLabel(self.devGroupBox)
        self.macLabel.setGeometry(QtCore.QRect(30, 77, 34, 16))
        self.macLabel.setObjectName(_fromUtf8("macLabel"))
        self.macContentLabel = QtGui.QLabel(self.devGroupBox)
        self.macContentLabel.setGeometry(QtCore.QRect(72, 77, 150, 16))
        self.macContentLabel.setText(_fromUtf8(""))
        self.macContentLabel.setObjectName(_fromUtf8("macContentLabel"))
        self.ipAddrLabel = QtGui.QLabel(self.devGroupBox)
        self.ipAddrLabel.setGeometry(QtCore.QRect(31, 98, 21, 16))
        self.ipAddrLabel.setObjectName(_fromUtf8("ipAddrLabel"))
        self.ipAddressLabel = QtGui.QLabel(self.devGroupBox)
        self.ipAddressLabel.setGeometry(QtCore.QRect(72, 98, 150, 16))
        self.ipAddressLabel.setText(_fromUtf8(""))
        self.ipAddressLabel.setObjectName(_fromUtf8("ipAddressLabel"))
        self.ipv6AddrLabel = QtGui.QLabel(self.devGroupBox)
        self.ipv6AddrLabel.setGeometry(QtCore.QRect(31, 118, 31, 16))
        self.ipv6AddrLabel.setObjectName(_fromUtf8("ipv6AddrLabel"))
        self.ipv6Address1Label = QtGui.QLabel(self.devGroupBox)
        self.ipv6Address1Label.setGeometry(QtCore.QRect(72, 118, 150, 16))
        self.ipv6Address1Label.setText(_fromUtf8(""))
        self.ipv6Address1Label.setObjectName(_fromUtf8("ipv6Address1Label"))
        self.ipv6Address2Label = QtGui.QLabel(self.devGroupBox)
        self.ipv6Address2Label.setGeometry(QtCore.QRect(72, 139, 150, 16))
        self.ipv6Address2Label.setText(_fromUtf8(""))
        self.ipv6Address2Label.setObjectName(_fromUtf8("ipv6Address2Label"))
        self.ipv6Address3Label = QtGui.QLabel(self.devGroupBox)
        self.ipv6Address3Label.setGeometry(QtCore.QRect(72, 159, 150, 16))
        self.ipv6Address3Label.setText(_fromUtf8(""))
        self.ipv6Address3Label.setObjectName(_fromUtf8("ipv6Address3Label"))
        ...
        self.statGroupBox.setGeometry(QtCore.QRect(10, 350, 241, 321))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.descLabel.setText(QtGui.QApplication.translate("MainWindow", "Info", None, QtGui.QApplication.UnicodeUTF8))
        self.macLabel.setText(QtGui.QApplication.translate("MainWindow", "MAC: ", None, QtGui.QApplication.UnicodeUTF8))
        self.ipAddrLabel.setText(QtGui.QApplication.translate("MainWindow", "IP:", None, QtGui.QApplication.UnicodeUTF8))
        self.ipv6AddrLabel.setText(QtGui.QApplication.translate("MainWindow", "IPv6:", None, QtGui.QApplication.UnicodeUTF8))
